...
const BACKEND_REPORTS_API = import.meta.env.VITE_API_URL ? `${import.meta.env.VITE_API_URL}/api/reports` : (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://localhost:5001/api/reports' : 'https://waterleaklk1.vercel.app/api/reports');
